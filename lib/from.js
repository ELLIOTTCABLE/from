...
/* (One caveat: This code has to work both client-side and server-side, and all the way back to IE6               /*|   /*  to which this file is concatenated at test-time.) */                                           /*
   ...
   var /* (hoisted): */ isClient, runInNewContext
     , /* Utility: */ hasPrototypeAccessors, subclass
   ...
   html = nodeFor('html')                                                                                         /*|   /* We delay executing $$$(), an enclosure surrounding each successive layer of the API             */
   head = nodeFor('head')                                                                                         /*|    * until the *end* of the next section; that allows our utility definitions and shims to take      */
   body = nodeFor('body')                                                                                         /*|    * effect *before* the majority of the library-code, while being placed *below* the more
                                                                                                                  /*|    * relevant (and readable) code that we present to readers at the top of the file. */
   isClient(); hasPrototypeAccessors()                                                                            /*|*/;$$$()
