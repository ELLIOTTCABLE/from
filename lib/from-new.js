...
;(function(){ if(typeof(from)!=="undefined"&&from){module.exports=from;return from}; return (function(){
    ...
    ;(iterate = function(stack){ var sink, tip = stack[stack.length - 1], up = stack[stack.length - 2]
      tip.mutator.call(that.from, up? up.paths[0]:path, path, (climb = function(e, paths){
        ...
        probe((tip.paths = paths)[0], function(e, extant){ // if (e) return _(e)
          console.log(new(Array)(stack.length * 2).join(" ") + "("+tip.mutator.tag+") " + tip.paths[0])
  ...
  extensionMut = new(ResolutionMutator)(function(path, query, _){
    _(u, this.extensions.map(function(extension){ return path+extension })) }, { after:null, tag:"extension" })
  ...
  initializerMut = new(ResolutionMutator)(function(path, query, _){
    _(u, [path+"/"+path.slice(path.lastIndexOf('/') + 1)]) }, { after:[extensionMut], tag:"initializer" })
  ...
  libMut = new(ResolutionMutator)(function(path, query, _){
    _(u, [path.replace(query, "lib/"+query)]) }, { after:[extensionMut, initializerMut], tag:"lib" })
  ...
  relativeMut = new(ResolutionMutator)(function(path, query, _){ var e
    ...
    _(u, [path]) }, { after:[extensionMut, initializerMut, libMut], tag:"relative" })
  ...
  absoluteMut = new(ResolutionMutator)(function(path, query, _){
    _(u, [path]) }, { after:[extensionMut, initializerMut], tag:"absolute" })
