...
;(function(){ if(typeof(from)!=="undefined"&&from){module.exports=from;return from}; return (function(){
  ...
  ;(function(){ var super = Function
    ;((From = function(blueprint){ var that
      (that = function(){return that.body.apply(that, arguments)})['__proto__'] = From.prototype
  ...
  ;(function(){ var super = Function
    ;((Acquisition = function(blueprint){ var that
      (that = function(){return that.body.apply(that, arguments)})['__proto__'] = Acquisition.prototype
  ...
  From.prototype.body = function(pathBit, pathBit, pathBit /* ... */, _){ var acquisition, paths
  ...
  Acquisition.prototype.body = function(_){ var that = this, iterate
