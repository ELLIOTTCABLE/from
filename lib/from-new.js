...
;(function(){ if(typeof(from)!=="undefined"&&from){module.exports=from;return from}; return (function(){
  var from, From, f, paths, extensions, filename, undefined //= undefined
  ...
  ;(function(){ var super = Function
    ;((From = function(blueprint){ var that = this
      super.apply(this, ['return from.apply(that, arguments)'].concat(Array.prototype.slice.call(arguments, 1)))
  ...
  executeScript = function(script, exports){ var sources, from, sandbox = new(Object)()
    for (source in (sources = [global, { from:(from = new(From)({filename:script.filename})), 
                                            imports:from.imports, require:legacyRequire(from),
                                            __filename:script.filename, global:sandbox }, exports]))
  ...
  from = function(pathBit, _){ /* … */ }
  
  f = new(From)({filename:filename, library:"from", root:true})
if (typeof(module) !== "undefined") module.exports = f; return f })() })()
