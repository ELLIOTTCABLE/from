...
;(function(){ if(typeof(from)!=="undefined"&&from){module.exports=from;return from}; return (function(){
  var root, From, Acquisition, ResolutionMutator, undefined, u = undefined
    ...
    , paths, extensions, filename, basicMutators
  ...
  mutate = function(path, mutator, _) { var that = this, iterate
    ;(iterate = function(stack){ var sink, tip = stack[stack.length - 1], up = stack[stack.length - 2]
      tip.mutator.call(that.from, up? up.paths[0]:path, path, (climb = function(e, paths){ if (e) return _(e)
  ...
  extensionMut = new(ResolutionMutator)(function(path, query, _){ var
    _(u, this.extensions.map(function(extension){ return path+extension })) }, { after:null })
  ...
  initializerMut = new(ResolutionMutator)(function(path, query, _){
    _(u, [path+"/"+path.slice(path.lastIndexOf('/') + 1)]) }, { after:[extensionMut] })
  ...
  libMut = new(ResolutionMutator)(function(path, query, _){
    _(u, [path.replace(query, "lib/"+query)]) }, { after:[extensionMut, initializerMut] })
                                                                                    ;From.prototype.muts.subdir =
  subdirMut = new(ResolutionMutator)(function(path, query, _){ _(u, [path]) })
                                                                                ;From.prototype.muts.repository =
  repositoryMut = new(ResolutionMutator)(function(path, query, _){ _(u, [path]) })
                                                                                  ;From.prototype.muts.relative =
