...
;(function() { if(typeof(from)!=="undefined"&&from){module.exports=from;return from}
  var super, From, from, posix, paths, extensions, filename, undefined //= undefined
  ...
  executeScript = function(script, exports){ var globals = new(Object)(),
    injections = { __filename: script.filename, from: new(From)({filename: script.filename}), require: require },
    sources = [global,injections,exports]
    for (source in sources) for (variable in sources[source]) if (sources[source].hasOwnProperty(variable))
      globals[variable] = sources[source][variable]
  ...
  constructExecuter = function(compiler){ return function(pathBit, exports, _){
    compiler(pathBit, function(e, script, pathBit){ if(e)return _(e)
      process.nextTick(function(){
        _(undefined, executeScript(script, exports)) }) }) }}
  
  // =============
  // = Porcelain =
  // =============
  
  From.prototype['resolve'] = new(Object)()
  ...
  From.prototype['resolve']['absolute'] = absoluteResolver
  
  From.prototype['compile'] = new(Object)()
  From.prototype['compile']['absolute'] = absoluteCompiler = constructCompiler(absoluteResolver)
  
  From.prototype['execute'] = new(Object)()
  From.prototype['execute']['absolute'] = absoluteExecuter = constructExecuter(absoluteCompiler)
  
if (typeof(module) !== 'undefined') module.exports = from = new(From)({filename:filename}); return from })()
