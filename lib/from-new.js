...
;(function(){ if(typeof(from)!=="undefined"&&from){module.exports=from;return from}; return (function(){
  ...
  extensionMut = new(ResolutionMutator)( function(path, query, _){ var
    ...
    _(u, paths) }, { after:[] } )                                              ;From.prototype.muts.initializer =
  initializerMut = new(ResolutionMutator)( function(path, query, _){
    path = path+"/"+path.slice(path.lastIndexOf('/') + 1)
    _(u, [path]) }, { after:[extensionMut] } )                                         ;From.prototype.muts.lib =
  libMut = new(ResolutionMutator)( function(path, query, _){
    _(u, [path]) } )                                                                ;From.prototype.muts.subdir =
  subdirMut = new(ResolutionMutator)( function(path, query, _){
    _(u, [path]) } )                                                            ;From.prototype.muts.repository =
  repositoryMut = new(ResolutionMutator)( function(path, query, _){
    _(u, [path]) } )                                                              ;From.prototype.muts.relative =
  relativeMut = new(ResolutionMutator)( function(path, query, _){
    _(u, [path]) } )
